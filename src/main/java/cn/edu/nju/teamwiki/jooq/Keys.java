...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<KnowledgeRecord, UserRecord> USER_FK = Internal.createForeignKey(cn.edu.nju.teamwiki.jooq.Keys.KEY_USER_PRIMARY, Knowledge.KNOWLEDGE, "user_fk", Knowledge.KNOWLEDGE.UPLOADER);
