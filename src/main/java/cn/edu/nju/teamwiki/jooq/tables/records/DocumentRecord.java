...
public class DocumentRecord extends UpdatableRecordImpl<DocumentRecord> implements Record8<String, String, Integer, LocalDateTime, LocalDateTime, Integer, Integer, String> {

    private static final long serialVersionUID = -1237502260;
    ...
    @Override
    public Row8<String, String, Integer, LocalDateTime, LocalDateTime, Integer, Integer, String> valuesRow() {
    ...
    @Override
    public DocumentRecord values(String value1, String value2, Integer value3, LocalDateTime value4, LocalDateTime value5, Integer value6, Integer value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DocumentRecord(String dId, String dName, Integer uploader, LocalDateTime uploadedTime, LocalDateTime modifiedTime, Integer sourceType, Integer sourceId, String url) {
        super(Document.DOCUMENT);
