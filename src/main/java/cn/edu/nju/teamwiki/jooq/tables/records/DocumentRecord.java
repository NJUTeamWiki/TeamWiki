...
public class DocumentRecord extends UpdatableRecordImpl<DocumentRecord> implements Record9<String, String, Integer, LocalDateTime, LocalDateTime, Integer, Integer, String, Boolean> {

    private static final long serialVersionUID = -1777386067;
    ...
    /**
     * Setter for <code>team_wiki.document.url</code>.
     */
    ...
    /**
     * Getter for <code>team_wiki.document.url</code>.
     */
    ...
    /**
     * Setter for <code>team_wiki.document.is_archived</code>.
     */
    ...
    /**
     * Getter for <code>team_wiki.document.is_archived</code>.
     */
    ...
    @Override
    public Row9<String, String, Integer, LocalDateTime, LocalDateTime, Integer, Integer, String, Boolean> valuesRow() {
    ...
    public Field<Boolean> field9() {
        return Document.DOCUMENT.IS_ARCHIVED;
    }
    ...
    @Override
    public DocumentRecord values(String value1, String value2, Integer value3, LocalDateTime value4, LocalDateTime value5, Integer value6, Integer value7, String value8, Boolean value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DocumentRecord(String dId, String dName, Integer uploader, LocalDateTime uploadedTime, LocalDateTime modifiedTime, Integer sourceType, Integer sourceId, String url, Boolean isArchived) {
        super(Document.DOCUMENT);
