...
public class KnowledgeDao extends DAOImpl<KnowledgeRecord, cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge, Integer> {

    /**
     * Create a new KnowledgeDao without any configuration
     */
    public KnowledgeDao() {
        super(Knowledge.KNOWLEDGE, cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge.class);
    }
    ...
    public KnowledgeDao(Configuration configuration) {
        super(Knowledge.KNOWLEDGE, cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge.class, configuration);
    }

    @Override
    public Integer getId(cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge object) {
     ...
     */
    public List<cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge> fetchRangeOfKId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge> fetchByKId(Integer... values) {
     ...
     */
    public cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge fetchOneByKId(Integer value) {
     ...
     */
    public List<cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge> fetchRangeOfKName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge> fetchByKName(String... values) {
     ...
     */
    public List<cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge> fetchRangeOfStoragePath(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge> fetchByStoragePath(String... values) {
     ...
     */
    public List<cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge> fetchRangeOfUploader(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge> fetchByUploader(Integer... values) {
     ...
     */
    public List<cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge> fetchRangeOfUploadTime(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<cn.edu.nju.teamwiki.generator.tables.pojos.Knowledge> fetchByUploadTime(LocalDateTime... values) {
